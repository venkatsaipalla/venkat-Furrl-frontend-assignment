...
const ProductShareModal = ({ onClose, id }: ModalProps) => {
  ...
  const shareLink = `https://furrl.in/productDetail?id=${id}&ref=vibeResults_HomeHunts`;
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-white w-10/12 p-6 rounded-lg shadow-lg z-50">
        <div className="text-xl text-gray-800 flex flex-col gap-2">
          <p>Share this product:</p>
          <p className="font-semibold text-sm	text-wrap">{shareLink}</p>
          <div className="mt-3">
